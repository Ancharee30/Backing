...
class RegisterVisual extends StatefulWidget {
  final VoidCallback showLoginPage;
  const RegisterVisual({Key? key, required this.showLoginPage})
      : super(key: key);

  @override
  State<RegisterVisual> createState() => _RegisterVisualState();
}

class _RegisterVisualState extends State<RegisterVisual> {
