...
class ProfileHand extends StatelessWidget {
  const ProfileHand({super.key});
                  ...
                  child: GestureDetector(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color.fromARGB(255, 181, 216, 202),
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const SettingVisual()),
                    );
                  },
                  child: Column(
                      ...
                      child: GestureDetector(
                        child: Container(
                          ...
                          padding: const EdgeInsets.symmetric(
                              horizontal: 20, vertical: 10),
                          decoration: BoxDecoration(
                            color: const Color.fromARGB(255, 126, 144, 210),
                            borderRadius: BorderRadius.circular(20),
                          ),
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      child: GestureDetector(
                        child: Container(
                          ...
                          padding: const EdgeInsets.symmetric(
                              horizontal: 20, vertical: 10),
                          decoration: BoxDecoration(
                            color: const Color.fromARGB(255, 241, 240, 162),
                            borderRadius: BorderRadius.circular(30),
                            border: Border.all(
