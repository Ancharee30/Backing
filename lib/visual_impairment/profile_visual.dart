...
import 'package:flutter_application_14/visual_impairment/home_visual.dart';
import 'package:flutter_application_14/visual_impairment/setting_visual.dart';

class ProfilecVisual extends StatelessWidget {
  const ProfilecVisual({super.key});
                      ...
                      child: GestureDetector(
                        child: Container(
                          ...
                          padding: const EdgeInsets.symmetric(
                              horizontal: 20, vertical: 10),
                          decoration: BoxDecoration(
                            color: const Color.fromARGB(255, 240, 119, 119),
                            borderRadius: BorderRadius.circular(30),
                            border: Border.all(
                              color: const Color.fromARGB(255, 255, 255, 255),
                              width: 2,
