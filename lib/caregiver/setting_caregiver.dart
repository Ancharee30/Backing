...
import 'package:flutter_application_14/caregiver/profile_caregiver.dart';
import 'package:flutter_application_14/caregiver/profile_caregiver_eye.dart';

import 'login/loginPage.dart';

class SettingCaregiver extends StatelessWidget {
  const SettingCaregiver({super.key});
                      ...
                      child: GestureDetector(
                        child: Container(
                          ...
                          padding: const EdgeInsets.symmetric(
                              horizontal: 20, vertical: 10),
                          decoration: BoxDecoration(
                            color: const Color.fromARGB(255, 208, 216, 209),
                            borderRadius: BorderRadius.circular(30),
                          ),
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              const Text(
                                "ข้อมูลผู้บกพร่องทางสายตาที่ดูแล",
                                style: TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
